...
class _Level3LayoutState extends State<Level3Layout> {
          ...
          default:
            if (snapshot.hasError) {
              ...
              //   scrollDirection: Axis.horizontal,
                    child: Stack(
                      children: [
                        RotatedBox(quarterTurns: 1, child:  Image.asset('assets/level3/Frame 10.png',width: MediaQuery.of(context).size.width,
                        height: 800.h,),),
                        ...
                        Positioned(
                            ...
                            child: InkWell(child: Image.asset('assets/Group 493.png',width: 90.w,),onTap: (){
                        ...
                        Positioned(
                            ...
                            child: Image.asset('assets/chairs/chair_of_table.png',height: 90.h,)),
                        ...
                        Positioned(
                            ...
                            InkWell(child: Image.asset('assets/chairs/table.png',height: 70.w,),
                            onTap: (){
                          ...
                          //  right: 1.w,
                            ...
                            InkWell(
                              child: SizedBox(
                                ...
                                child: Column(
                                  children: [
                                      Image.asset('assets/chairs/chair_down_paired.png'),

                                  Image.asset('assets/chairs/small_table.png',),
                                    Image.asset('assets/chairs/chair_down_paired.png'),
                    ...
                    //         crossAxisAlignment: CrossAxisAlignment.start,
                    //         children: [
                    //           SvgPicture.asset('assets/background image.svg'),
                    //           // Row(
                    //           //   mainAxisAlignment:
                    //           //       MainAxisAlignment.spaceBetween,
                    //           //   children: [
  ...
  // Widget midtable1(int tableNo, List<int> seats){
  //   Stack(
  //     children: [
  //       Container(
  //         child: Image.asset(
                          ...
                          child: Column(
                            children: [
                              ...
                              RotatedBox(
                                ...
                                quarterTurns: 2,
                                child: Image.asset(
                                  "assets/chairs/available.png", color: seats.contains(7)
                                    ? AppColors.kRed
                                    : (table == tableNo && seat == 7)
                                    ? AppColors.kOrange
                                    : AppColors.kEvergreen,
                          ...
                          child: Column(
                            children: [
                                ...
                                RotatedBox(
                                  ...
                                  quarterTurns: 2,
                                  child: Image.asset(
                                    "assets/chairs/available.png", color: seats.contains(8)
                                      ? AppColors.kRed
                                      : (table == tableNo && seat == 8)
                                      ? AppColors.kOrange
                                      : AppColors.kEvergreen,
                ...
                children: [
                  ...
                  Container(
                    ...
                    Stack(
                      children: [
                        Center(
                            child: Image.asset('assets/level3/Rectangle 146.png',)
